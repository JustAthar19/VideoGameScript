from classses.game import Person, bcolors
from classses.magic import Spell
from classses.inventory import Item
import random
...
# Instantiate People
player1 = Person("Steve:", 3260, 300, 60, 34, player_spells, player_items)
player2 = Person("Athar:", 4160, 311, 60, 34, player_spells, player_items)
player3 = Person("Stark:", 3089, 288, 60, 34, player_spells, player_items)

enemy1 = Person("Ikan     ", 1250, 130, 560, 325,enemy_spells,[])
enemy2 = Person("Thanos ",18200, 701, 525, 25, enemy_spells,[])
enemy3 = Person("Ikan     ",1250, 130, 560, 325, enemy_spells, [])
